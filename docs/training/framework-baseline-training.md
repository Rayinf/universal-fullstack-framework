...
本文面向第一次接触本仓库的同事，目标不是教对方立刻写某个页面，而是先建立正确的“系统地图”。
...
它已经不是“完整做完的 MES 全业务系统”，也不是“只有页面壳子的 demo”。  
更准确地说，它是一个可以持续扩展的业务系统框架。

## 2. 当前代码状态要以什么为准

培训时务必明确：

1. 旧版 `README.md` 中“仅保留系统管理模块”的表述已经落后。
...
“现在看到的销售和生产页面，不是额外拼出来的临时分支，而是这个基座已经允许启用的示范业务域。”
