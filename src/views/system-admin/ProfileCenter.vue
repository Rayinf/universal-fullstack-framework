  ...
  <div class="page-view">
    <div class="page-header">
      <div class="title-container">
        ...
        <div class="title-row">
          <h2>个人中心</h2>
          <div class="page-description">管理您的账户信息和安全设置</div>
        </div>
      </div>
    </div>

    <!-- 个人信息展示 -->
    <div class="content-card" style="margin-bottom: 20px; flex: none;">
      <div class="info-section" style="padding: 24px; margin-bottom: 0;">
        <h4>个人信息</h4>
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="角色">
            <el-tag type="primary">{{ user?.role || '未设置' }}</el-tag>
    ...
    <div class="content-card" style="flex: none;">
      <div class="info-section" style="padding: 24px; margin-bottom: 0;">
        <h4>修改密码</h4>
        <p style="color: var(--el-text-color-secondary); font-size: 13px; margin-bottom: 16px;">为了账户安全，请定期修改密码</p>
    ...
    <!-- 修改密码弹窗 -->
    <el-drawer v-model="showPasswordDialog" title="修改密码" :size="480" direction="rtl">
      <div class="password-drawer-content">
        ...
        >
          <template #default> 为了您的账户安全，请设置复杂度较高的密码，并定期更换。 </template>
        </el-alert>
